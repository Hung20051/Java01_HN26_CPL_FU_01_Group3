...
('Circuit Breaker 3P',    3, '3-phase circuit breaker 100A',                        8900000, 5),
('Contactor 40A',         3, 'Magnetic contactor for motor control',                3200000, 5),
('V-Belt Drive',          4, 'Industrial V-belt for fan/pump drive',                1850000, 5),
('Shaft Coupling',        4, 'Flexible shaft coupling for pump',                    9600000, 5);

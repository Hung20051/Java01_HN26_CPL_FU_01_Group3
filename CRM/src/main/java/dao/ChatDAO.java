...
public class ChatDAO {
     ...
     */
    public void updatePresence(int userId) throws Exception {
        String sql = """
    ...
    private ChatMessage map(ResultSet rs) throws SQLException {
        ...
        m.setDelivered(rs.getInt("is_delivered") == 1);
        m.setRecalled(rs.getInt("is_recalled") == 1);
        m.setPinned(rs.getInt("is_pinned") == 1);
        // Attachment

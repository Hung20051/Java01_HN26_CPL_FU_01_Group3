...
public class ReviewDAO {
    ...
    /**
     * Trả về true nếu customer có ít nhất 1 invoice PURCHASE thành công chứa
     * sản phẩm với ref_item_id = itemId và item_type = itemType. Chỉ tính
     * invoice có payment SUCCESS (đã thanh toán) hoặc UNPAID (COD chờ giao).
     */

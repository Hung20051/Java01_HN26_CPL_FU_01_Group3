...
public class AppConfig {
    ...
    public static String getEmailSender() { return props.getProperty("email.sender"); }
    public static String getEmailPassword(){ return props.getProperty("email.password"); }
}
...
public class User {
    ...
    // ═══════════════════════════════════════════════════
    /**
     * Tự build địa chỉ đầy đủ từ các thành phần (dùng khi chưa có addressFull
     * trong DB)
     */
    public String buildFullAddress() {
        ...
        if (addressWard != null && !addressWard.isBlank()) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(addressWard);
        }
        if (addressDistrict != null && !addressDistrict.isBlank()) {
            if (sb.length() > 0) {
                sb.append(", ");
            }

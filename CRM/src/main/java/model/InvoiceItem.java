...
public class InvoiceItem {
    private int id; private int invoiceId; private String itemName;
    private String itemType; private int quantity; private BigDecimal unitPrice; private BigDecimal totalPrice;
    public int getId(){return id;} public void setId(int id){this.id=id;}
    public int getInvoiceId(){return invoiceId;} public void setInvoiceId(int v){invoiceId=v;}

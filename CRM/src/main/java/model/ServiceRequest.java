...
public class ServiceRequest {
    ...
    public List<ServiceRequestEquipment> getEquipmentList() { return equipmentList; }
    public void setEquipmentList(List<ServiceRequestEquipment> equipmentList) { this.equipmentList = equipmentList; }
}
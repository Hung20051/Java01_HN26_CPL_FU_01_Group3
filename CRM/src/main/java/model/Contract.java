...
public class Contract {
    ...
    public int getServiceRequestCount() { return serviceRequestCount; }
    public void setServiceRequestCount(int serviceRequestCount) { this.serviceRequestCount = serviceRequestCount; }

    public List<CustomerEquipment> getEquipmentList() { return equipmentList; }
    public void setEquipmentList(List<CustomerEquipment> equipmentList) { this.equipmentList = equipmentList; }
}
...
public class ChatMessage {
    private int id; private int senderId; private String senderName;
    private String senderAvatar; private int receiverId; private String message;
    ...
    public String getSenderAvatar(){return senderAvatar;} public void setSenderAvatar(String v){senderAvatar=v;}
    public int getReceiverId(){return receiverId;} public void setReceiverId(int v){receiverId=v;}

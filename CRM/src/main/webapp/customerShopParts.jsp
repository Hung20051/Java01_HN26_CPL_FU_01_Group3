...
<html lang="en">
    ...
    <body>
        <aside class="sidebar">
            ...
            <a href="<%= ctx %>/customerShop?action=parts"     class="nav-item active"><i class="fas fa-puzzle-piece"></i> Parts</a>
        ...
        <main class="main">
            ...
            <!-- TABS -->
            <div class="shop-tabs">
                <a href="<%= ctx %>/customerShop?action=parts"     class="shop-tab active"><i class="fas fa-puzzle-piece"></i> Parts</a>
                <a href="<%= ctx %>/customerShop?action=equipment" class="shop-tab"><i class="fas fa-server"></i> Equipment</a>
            </div>
            ...
            <form method="get" action="<%= ctx %>/customerShop">
                ...
                <div class="toolbar">
                    <input class="search-input" type="text" name="keyword" placeholder="Search parts..." value="<%= keyword %>">
                ...
                <div class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <form method="post" action="<%= ctx %>/customerShop" class="add-to-cart-form">
                            ...
                            <button type="submit" class="btn-add"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </form>
                    </div>
                </div>
                <% } %>

...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .welcome-banner::before{content:'';position:absolute;top:0;left:20px;right:20px;height:1px;background:linear-gradient(90deg,transparent,rgba(245,158,11,0.4),transparent);}
        .welcome-icon{width:48px;height:48px;border-radius:13px;background:rgba(245,158,11,0.12);border:1.5px solid rgba(245,158,11,0.25);display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0}
        .welcome-banner h3{font-size:1rem;font-weight:700;color:var(--text-h);margin-bottom:4px}
        .welcome-banner p{font-size:.8rem;color:var(--text-m)}
        ...
        .sc:nth-child(1){animation-delay:.05s} .sc:nth-child(2){animation-delay:.10s} .sc:nth-child(3){animation-delay:.15s}
        ...
        .sc-val{font-size:2rem;font-weight:800;color:#fff;line-height:1;letter-spacing:-1px;position:relative;z-index:1}
        .sc-lbl{color:rgba(255,255,255,0.88);font-size:.76rem;font-weight:600;margin-top:5px;position:relative;z-index:1}

        /* Management cards */
        .cards-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:16px;margin-bottom:26px;}
        .mgmt-card{background:var(--bg-card);border:1.5px solid var(--border-light);border-radius:16px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,0.05);transition:all .22s;animation:cardIn .5s ease both;}
        .mgmt-card:nth-child(1){animation-delay:.2s} .mgmt-card:nth-child(2){animation-delay:.25s}
        .mgmt-card:hover{transform:translateY(-2px);box-shadow:0 10px 28px rgba(0,0,0,0.1)}
        .mgmt-icon{width:46px;height:46px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.15rem;margin-bottom:14px;}
        .mgmt-icon.blue {background:var(--primary-light);color:var(--primary-2)}
        .mgmt-icon.green{background:#dcfce7;color:var(--green)}
        .mgmt-card h3{font-size:.92rem;font-weight:700;color:var(--text-h);margin-bottom:6px}
        .mgmt-card p{font-size:.78rem;color:var(--text-m);margin-bottom:16px;line-height:1.6}
        .btn-group{display:flex;flex-direction:column;gap:8px}
        .btn{display:flex;align-items:center;justify-content:center;gap:8px;padding:10px 16px;border-radius:10px;font-size:.82rem;font-weight:700;font-family:'Sora',sans-serif;text-decoration:none;border:none;cursor:pointer;transition:all .2s;}
        ...
        .system-info-hd i{color:var(--primary-2)}
        .info-grid{display:grid;grid-template-columns:1fr 1fr;gap:24px}
        .info-col h4{font-size:.65rem;font-weight:700;color:var(--text-s);text-transform:uppercase;letter-spacing:1.4px;margin-bottom:12px}
        .info-item{display:flex;align-items:center;gap:9px;font-size:.82rem;color:var(--text-b);margin-bottom:9px}
        .info-item i{width:20px;height:20px;border-radius:6px;background:#dcfce7;color:var(--green);display:flex;align-items:center;justify-content:center;font-size:.62rem;flex-shrink:0}
    </style>
</head>
<body>

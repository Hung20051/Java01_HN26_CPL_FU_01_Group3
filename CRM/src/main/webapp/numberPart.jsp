...
<head>
    ...
    <title>Danh sách linh kiện - CRM System</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .detail-title { font-size: 0.95rem; font-weight: 600; color: #1e40af; margin-bottom: 12px;
            display: flex; align-items: center; gap: 8px; }
        .detail-stats { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; }
        .detail-stat { background: white; border-radius: 8px; padding: 12px; border-left: 3px solid #e2e8f0; }
        .detail-stat.av  { border-left-color: #10b981; }
        .detail-stat.fa  { border-left-color: #f59e0b; }
        .detail-stat.iu  { border-left-color: #6366f1; }
        .detail-stat.rt  { border-left-color: #94a3b8; }
        .detail-stat-label { font-size: 0.7rem; color: #64748b; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; }
        .detail-stat-value { font-size: 1.8rem; font-weight: 700; margin-top: 4px; }
        .detail-close { float: right; background: #ef4444; color: white; border: none;
        ...
        .link-username { color: #6366f1; text-decoration: none; font-weight: 500; }

        .action-btns { display: flex; gap: 6px; }
        .btn-detail  { background: #0891b2; color: white; padding: 5px 10px; font-size: 0.78rem; }
        .btn-edit    { background: #f59e0b; color: white; padding: 5px 10px; font-size: 0.78rem; }
        .btn-delete  { background: #ef4444; color: white; padding: 5px 10px; font-size: 0.78rem; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<%= ctx %>/numberPart"       class="nav-item active"><i class="fas fa-list-ul"></i> Danh sách linh kiện</a>
...
<main class="main">
    <div class="topbar">
        <div class="page-title">Danh sách linh kiện</div>
    ...
    <div class="toolbar">
        <input class="search-box" type="text" name="keyword" placeholder="Nhập từ khoá..." value="<%= keyword != null ? keyword : "" %>">
    ...
    <div class="card">
        <table>
            ...
            <tbody>
            <% if (parts.isEmpty()) { %>
            <tr><td colspan="8" style="text-align:center;color:#94a3b8;padding:30px">Không có linh kiện nào</td></tr>
...
<div class="modal">
    ...
    <form method="post" action="<%= ctx %>/numberPart">
        ...
        <div class="form-group">
            <label>Số lượng nhập kho (1-100)</label>
...
<div class="modal" style="text-align:center">
    ...
    <h3>Xác nhận xóa</h3>
    <p style="color:#64748b;margin:10px 0 20px">Bạn có chắc muốn xóa Part:<br><strong id="deletePartName"></strong> (ID: <span id="deletePartId"></span>)?</p>
    <form method="post" action="<%= ctx %>/numberPart">
        ...
        <div class="modal-btns">
            ...
            <button type="button" class="btn-cancel" onclick="closeModal('deleteModal')" style="flex:1;padding:10px;border-radius:8px;border:none;cursor:pointer;font-weight:600">✕ Hủy</button>
        </div>
    </form>
</div>
</div>

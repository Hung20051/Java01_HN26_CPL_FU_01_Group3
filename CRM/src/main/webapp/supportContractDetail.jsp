...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .status-banner.active   {background:#d1fae5;border:1.5px solid #a7f3d0;color:#065f46}
        .status-banner.active i {color:var(--green)}
        .status-banner.expired  {background:#fef3c7;border:1.5px solid #fde68a;color:#92400e}
        .status-banner.expired i{color:var(--amber)}
        .status-banner.cancelled  {background:#fee2e2;border:1.5px solid #fca5a5;color:#991b1b}
        .status-banner.cancelled i{color:var(--red)}
        ...
        .card-hd-title{font-size:.88rem;font-weight:700;color:var(--text-h);display:flex;align-items:center;gap:8px;}
        .card-hd-title i{color:var(--primary-2);font-size:.82rem}
        ...
        .info-value{color:var(--text-b);font-weight:600;text-align:right}
        ...
        .notes-box{
            ...
            background:#fafbff;
            border:1px solid var(--border-light);
            border-radius:10px;border-left:3px solid var(--primary-2);
            font-size:.81rem;color:var(--text-m);line-height:1.6;
        }
        ...
        .b-warranty-ok {background:#d1fae5;color:#065f46}
        .b-warranty-exp{background:#fee2e2;color:#991b1b}
        .b-source      {background:var(--primary-light);color:var(--primary-2);border:1px solid rgba(99,102,241,0.25);}
        .b-external    {background:#dbeafe;color:#1e40af}

        ...
        <style>
            ...
            *,*::before,*::after{
            ...
            .img-main{
                ...
                align-items:center;
                justify-content:center;
                background:linear-gradient(135deg,#f8f9ff,#f0f2fb);
                position:relative;
                overflow:hidden;
            }
            .img-main::before{
                ...
                position:absolute;
                inset:0;
                background:radial-gradient(circle at 50% 30%,rgba(79,70,229,0.05),transparent 70%);
            }
            .img-main img{
                max-width:88%;
                max-height:88%;
            ...
            .info-panel{
                ...
                flex-direction:column;
                gap:16px;
                animation:cardIn .5s .08s ease both;
            }
            .info-card{
                background:var(--bg-card);
                border:1.5px solid var(--border-light);
            ...
            .bottom-grid{
                ...
                gap:18px;
                animation:cardIn .5s .16s ease both;
            }
            .detail-card{
                background:var(--bg-card);
                border:1.5px solid var(--border-light);
            ...
            .units-table-wrap::-webkit-scrollbar{
                width:3px
            }
            .units-table-wrap::-webkit-scrollbar-thumb{

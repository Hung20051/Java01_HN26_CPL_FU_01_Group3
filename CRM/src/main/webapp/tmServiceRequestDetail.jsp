...
<%
    ...
    @SuppressWarnings("unchecked")
    List<TechnicianWorkload> workloads = (List<TechnicianWorkload>) request.getAttribute("workloads");
    if (workloads == null) workloads = new ArrayList<>();

    @SuppressWarnings("unchecked")
    List<WorkTask> assignedTasks = (List<WorkTask>) request.getAttribute("assignedTasks");

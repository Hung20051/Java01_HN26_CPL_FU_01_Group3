...
<%
    // Bảo vệ trang: chưa verify OTP thì redirect
...
<head>
    ...
    <title>Đặt lại mật khẩu - DRSMS System</title>
        ...
        <div class="auth-card">
            ...
            <form action="reset-password" method="post">
                <div class="form-group">
                    <label><i class="fas fa-lock"></i> Mật khẩu mới <span class="required">*</span></label>

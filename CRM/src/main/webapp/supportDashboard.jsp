...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* decorative circles */
        .sc::after {content:'';position:absolute;width:90px;height:90px;border-radius:50%;background:rgba(255,255,255,0.12);top:-24px;right:-24px;}
        .sc::before{content:'';position:absolute;width:55px;height:55px;border-radius:50%;background:rgba(255,255,255,0.07);bottom:-12px;right:22px;}

        .sc-icon{width:40px;height:40px;border-radius:11px;display:flex;align-items:center;justify-content:center;font-size:1rem;margin-bottom:14px;background:rgba(255,255,255,0.2);position:relative;z-index:1;}
        .sc-val{font-size:2.1rem;font-weight:800;line-height:1;letter-spacing:-1.5px;position:relative;z-index:1}
        .sc-lbl{font-size:.76rem;font-weight:600;opacity:.88;margin-top:5px;position:relative;z-index:1}
        .sc-sub{font-size:.7rem;opacity:.6;margin-top:3px;position:relative;z-index:1}
        ...
        .card-title{font-size:.85rem;font-weight:700;color:var(--text-h);display:flex;align-items:center;gap:8px;}

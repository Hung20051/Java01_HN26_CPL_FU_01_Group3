...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .alert{display:flex;align-items:center;gap:12px;padding:12px 18px;border-radius:12px;margin-bottom:20px;font-size:.82rem}
        ...
        .sc:hover{transform:translateY(-3px);box-shadow:0 12px 32px rgba(0,0,0,.18)}
        .sc-total{background:var(--blue);box-shadow:0 4px 20px rgba(37,99,235,.3)}
        .sc-draft{background:var(--amber);box-shadow:0 4px 20px rgba(217,119,6,.3)}
        .sc-done {background:var(--green);box-shadow:0 4px 20px rgba(22,163,74,.3)}
        .sc::after{content:'';position:absolute;width:80px;height:80px;border-radius:50%;background:rgba(255,255,255,.12);top:-20px;right:-20px}
        .sc-icon{width:34px;height:34px;border-radius:9px;display:flex;align-items:center;justify-content:center;
            font-size:.82rem;margin-bottom:10px;background:rgba(255,255,255,.2);position:relative;z-index:1}
        ...
        .filter-bar select{padding:9px 13px;border:1.5px solid var(--border-light);border-radius:9px;
            font-size:.81rem;font-family:'Sora',sans-serif;color:var(--text-b);background:#fff;outline:none}
        ...
        .table-wrap{background:var(--bg-card);border:1px solid var(--border-light);border-radius:16px;
        ...
        .pagination a,.pagination span{padding:6px 12px;border-radius:8px;font-size:.77rem;font-weight:500;
            text-decoration:none;color:var(--text-m);border:1.5px solid var(--border-light);background:#fff;transition:all .15s}
        .pagination a:hover{background:var(--primary-light);color:var(--primary-2)}
        ...
        .section-lbl::after{content:'';flex:1;height:1px;background:linear-gradient(to right,rgba(99,102,241,.2),transparent)}
    </style>
</head>
<body>

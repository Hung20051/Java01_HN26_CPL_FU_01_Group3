...
#ai-notif-dot {
    ...
    border: 2px solid #0b1437; display: none;
...
#ai-teaser {
    ...
    padding: 12px 16px 12px 14px; max-width: 230px;
...
.ai-hd-avatar {
    ...
    display: flex; align-items: center; justify-content: center;
    box-shadow: 0 0 16px rgba(167,139,250,0.4); flex-shrink: 0;
}

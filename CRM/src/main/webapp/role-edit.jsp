...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-title i { color: var(--purple); font-size: 0.95rem; }
        ...
        .card:nth-child(1) { animation: cardIn 0.5s 0.05s ease both; }
        .card:nth-child(2) { animation: cardIn 0.5s 0.12s ease both; }
        ...
        .btn-update:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(167,139,250,0.4); }
        ...
        .warning-box ul { list-style: none; display: flex; flex-direction: column; gap: 9px; }
        .warning-box ul li {
            display: flex; align-items: flex-start; gap: 10px;
            color: var(--text-2); font-size: 0.82rem; line-height: 1.55;
        }
        .warning-box ul li span.icon { flex-shrink: 0; font-size: 0.9rem; }
    </style>
</head>
<body>

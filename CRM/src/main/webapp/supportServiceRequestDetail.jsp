...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Breadcrumb */
        .breadcrumb{display:flex;align-items:center;gap:7px;font-size:.76rem;color:var(--text-s);margin-bottom:18px;}
        ...
        /* Cards */
        .card{background:var(--bg-card);border:1px solid var(--border-light);border-radius:16px;overflow:hidden;margin-bottom:18px;box-shadow:0 1px 6px rgba(0,0,0,0.05);animation:cardIn .45s ease both;}
        .card:nth-child(1){animation-delay:.05s}
        .card:nth-child(2){animation-delay:.12s}
        .card-hd{display:flex;align-items:center;gap:9px;padding:14px 18px;border-bottom:1px solid var(--border-light2);background:#fafbff;}
        ...
        /* Info rows */
        .info-row{display:flex;justify-content:space-between;align-items:center;padding:9px 0;border-bottom:1px solid var(--border-light2);font-size:.82rem;}
        .info-row:last-child{border-bottom:none}
        .info-label{color:var(--text-s);font-weight:500}
        .info-value{color:var(--text-b);font-weight:600;text-align:right;display:flex;align-items:center;gap:6px;flex-wrap:wrap;justify-content:flex-end;}
        ...
        /* Desc box */
        .desc-box{background:#fafbff;border:1px solid var(--border-light);border-radius:12px;padding:14px 16px;font-size:.83rem;color:var(--text-b);line-height:1.7;border-left:3px solid var(--primary-2);}

        /* Reject box */
        .reject-box{margin-top:14px;padding:13px 16px;background:#fee2e2;border:1.5px solid #fca5a5;border-radius:12px;}
        ...
        /* Contract link */
        .contract-link{color:var(--primary-2);text-decoration:none;font-weight:700;font-size:.82rem;font-family:'Courier New',monospace;transition:color .15s;}
        .contract-link:hover{color:var(--primary);text-decoration:underline}
        ...
        /* Contract type */
        .ct-badge{display:inline-flex;align-items:center;padding:2px 7px;border-radius:5px;font-size:.68rem;font-weight:700;}
        .ct-wr{background:#dbeafe;color:#1e40af}
        .ct-mt{background:#fef3c7;color:#92400e}

        /* Source badge */
        .src-badge{display:inline-flex;align-items:center;padding:2px 9px;border-radius:20px;font-size:.68rem;font-weight:700;background:var(--primary-light);color:var(--primary-2);border:1px solid rgba(99,102,241,0.25);}
        ...
        .td-empty{text-align:center;padding:28px 16px;color:var(--text-s);font-size:.82rem}
        .td-empty i{font-size:1.5rem;display:block;margin-bottom:8px;opacity:.2}

        /* Timeline */
        .timeline{display:flex;flex-direction:column;gap:0}
        .tl-item{display:flex;gap:13px;padding-bottom:18px;position:relative;}
        .tl-item:last-child{padding-bottom:0}
        .tl-dot{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.72rem;flex-shrink:0;margin-top:1px;}
        .tl-dot.done    {background:#d1fae5;color:var(--green);border:1px solid #a7f3d0;}
        .tl-dot.active  {background:var(--primary-light);color:var(--primary-2);border:1px solid rgba(79,70,229,0.3);}
        .tl-dot.pending {background:#f9fafb;color:var(--text-s);border:1px solid var(--border-light);}
        .tl-dot.rejected{background:#fee2e2;color:var(--red);border:1px solid #fca5a5;}
        .tl-line{position:absolute;left:14px;top:32px;bottom:0;width:2px;background:linear-gradient(180deg,var(--border-light),transparent);}
        .tl-item:last-child .tl-line{display:none}
        .tl-content{flex:1;padding-top:4px}
        .tl-title{font-size:.83rem;font-weight:600;color:var(--text-h)}
        .tl-title.dim{color:var(--text-s)}
        .tl-sub{font-size:.73rem;color:var(--text-s);margin-top:3px;line-height:1.5}
    </style>
</head>
<body>

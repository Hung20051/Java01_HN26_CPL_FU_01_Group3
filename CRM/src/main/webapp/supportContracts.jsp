...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .eq-count{display:inline-block;padding:2px 10px;border-radius:20px;font-size:.75rem;font-weight:600;background:var(--primary-light);color:var(--primary-2);border:1px solid rgba(99,102,241,0.25);}
        ...
        .b-WARRANTY   {background:#dbeafe;color:#1e40af}
        .b-MAINTENANCE{background:#fef3c7;color:#92400e}
        ...
        /* ── EQUIPMENT SELECTION ── */
        .equip-loading{text-align:center;padding:20px;color:var(--text-s);font-size:.82rem}
        .equip-list{display:flex;flex-direction:column;gap:8px;max-height:260px;overflow-y:auto;padding-right:2px;}
        .equip-list::-webkit-scrollbar{width:3px}
        .equip-list::-webkit-scrollbar-thumb{background:rgba(79,70,229,0.2);border-radius:4px}
        ...
        .equip-item:hover{border-color:rgba(79,70,229,0.3);background:var(--primary-light);}
        .equip-item.selected{border-color:rgba(79,70,229,0.4);background:var(--primary-light);}
        .equip-item input[type=checkbox]{accent-color:var(--primary);width:16px;height:16px;flex-shrink:0;}
        .equip-info{flex:1}
        .equip-name{font-size:.82rem;font-weight:600;color:var(--text-h)}
        .equip-meta{font-size:.72rem;color:var(--text-s);margin-top:1px}

        .equip-badge{font-size:.67rem;padding:1px 7px;border-radius:10px;font-weight:600;}
        .equip-warranty  {background:#d1fae5;color:#065f46;border:1px solid #a7f3d0;}
        .equip-expired   {background:#fee2e2;color:#991b1b;border:1px solid #fca5a5;}
        .equip-external  {background:#dbeafe;color:#1e40af;border:1px solid #bfdbfe;}
        .equip-empty{text-align:center;padding:20px;color:var(--text-s);font-size:.82rem}

        /* ── TYPE HINTS ── */
        .type-hint{
            padding:10px 14px;border-radius:9px;
            font-size:.78rem;margin-bottom:14px;display:none;
            align-items:center;gap:8px;
        }
        .type-hint.show{display:flex;}
        .hint-warranty   {background:#eff6ff;color:var(--info);border:1px solid #bfdbfe;}
        .hint-maintenance{background:#fffbeb;color:var(--amber);border:1px solid #fde68a;}
    </style>
</head>
<body>
    ...
    <script>
        ...
        function onCustomerChange() { loadEquipment(); }
        ...
        document.getElementById('createForm').addEventListener('submit', function(e) {
            ...
            if (checked.length === 0) { e.preventDefault(); alert('Please select at least one equipment.'); }
        });
    </script>
</body>
</html>

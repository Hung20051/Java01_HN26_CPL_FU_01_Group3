...
<html lang="en">
    ...
    <body>
        <aside class="sidebar">
            ...
            <a href="<%= ctx %>/customerShop?action=equipment" class="nav-item"><i class="fas fa-server"></i> Equipment</a>
            <a href="<%= ctx %>/customerShop?action=cart"      class="nav-item active"><i class="fas fa-shopping-cart"></i> Cart
            ...
            <a href="<%= ctx %>/customerChat" class="nav-item"><i class="fas fa-comments"></i> Live Chat</a>
        ...
        <main class="main">
            <div class="topbar">
                <div class="page-title"><i class="fas fa-shopping-cart"></i> Cart (<%= cartCount %> items)</div>
            </div>
            ...
            <div style="background:white;border-radius:12px;border:1px solid #e2e8f0">
                <div class="empty-cart">
                    ...
                    <a href="<%= ctx %>/customerShop?action=parts" class="btn-shop"><i class="fas fa-store"></i> Continue Shopping</a>
                </div>
            </div>
            <% } else { %>
            <div class="layout">
                ...
                <div class="cart-card">
                    <div class="cart-header">
                        <h2><i class="fas fa-list" style="color:#6366f1"></i> Item List</h2>
                ...
                <div class="summary-card">
                    <div class="summary-title"><i class="fas fa-receipt" style="color:#6366f1"></i> Order Summary</div>
                    <div class="summary-row"><span>Subtotal</span><span><%= nf.format((long)grandTotal) %> ₫</span></div>
                    <div class="summary-row"><span>VAT (10%)</span><span><%= nf.format((long)(grandTotal * 0.1)) %> ₫</span></div>
                    <hr class="summary-divider">
                    <div class="summary-total"><span>Total</span><span style="color:#ef4444"><%= nf.format((long)(grandTotal * 1.1)) %> ₫</span></div>
                    ...
                    <form method="post" action="<%= ctx %>/customerShop">
                        ...
                        <button type="submit" class="btn-pay btn-vnpay">
                            <span style="font-weight:900;font-size:1rem">VN</span>Pay &nbsp;— Pay Online
                        </button>
                    </form>
